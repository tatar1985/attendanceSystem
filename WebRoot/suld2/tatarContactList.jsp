...
.orderTYG{ height:55px; position:relative; background-color:#fff; margin-bottom:14px;}
.orderTYG1{ float:left; width:20%; line-height:43px; color:#65646b; font-size:14px; text-align:center}
.orderTYG2{ float:left; width:45%; line-height:43px; color:#65646b; font-size:14px; text-align:left}
.orderTYG3{ float:left; width:35%; line-height:43px; color:#65646b; font-size:14px; text-align:left}
...
.order_textTyg{ width:92%; margin-left:4%; position:relative; height:30px; padding-top:5px; box-sizing:border-box}
     ...
     %>
        <div class="orderTYG" >
            ...
            <div class="order_text">
                <div class="border_top"></div>              
                <div class="orderTYG1">
               <img src="<%=bean==null?"":bean.getHeadUrl() %>" style="height: 35px; width: 38px; ">
               </div>
                <div class="orderTYG2">
                	 <h2><%=bean.getUserName()==null?"":bean.getUserName() %></h2>
                	 <h1><%=bean.getDepartmentName()==null?"":bean.getDepartmentName() %> </h1>
               </div>
               <div class="orderTYG3"><%=bean.getMobile()==null?"":bean.getMobile() %></div>
        ...
        <div class="order" >
           ...
           <div class="order_title"><%=bean.getTaskname() %></div> 
            <div class="order_text">
                ...
                <h1>截止日期：<%=bean.getDeadline() %></h1>
                <p>积分：<%=bean.getScore() %></p>
                <div class="border_bottom"></div>
            </div>
            <div class="cancel" onclick="submitBtn('<%=bean.getSid()%>','3')">删除</div><div class="cancel" onclick="submitBtn('<%=bean.getSid()%>','4')" style="border:#ff7f00 1px solid; color:#ff7f00;" id="acceptBtn" >提交</div> 
            <div class="border_bottom"></div>
             </div> 
        <%}} %>    
         <br><br>   
    ...
    <%
     ...
     %>
        <div class="order" >
            ...
            <div class="order_text">
                <div class="border_top"></div>
                <h2><%=bean.getDeadline() %></h2>
                <h2><%=bean.getContent() %></h2>
                <div class="border_bottom"></div>
            </div>
            <div class="cancel" style="border:#ff7f00 1px solid; color:#ff7f00;" >未读</div>
            <div class="border_bottom"></div>
             </div> 
        <%}} %>
...
<div class="nav_box">
	...
	<div class="nav_index chenge" onclick="document.location='<%=request.getContextPath()%>/hurd_/hurd.do?method=contactQuery';">
    	<img src="<%=request.getContextPath()%>/suld/images/phone1.png">
        <h1 style="color:#01AFF0">通讯</h1>
    </div>
    <div class="nav_order chenge"  >
