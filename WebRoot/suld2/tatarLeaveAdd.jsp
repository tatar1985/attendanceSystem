...
<div class="column_box_tatar2">
    ...
    <input name="startTime" class="ipt datepicker" size="16" type="text" id="starTime"  placeholder="开始时间" style="height: 46px; width: 89px; "/>
...
<div class="column_box_tatar2">
	<div class="column_img_tatar"><img src="<%=request.getContextPath()%>/suld/images/time.png"></div>
	<input name="endTime" class="ipt datepicker" size="16" type="text" id="endTime"  placeholder="结束时间" style="height: 46px; width: 89px; "/>
...
$("#buttonSub").click(function(){
	...
	if(getDays(startTime,endTime)>=2){
		if($("#adminLeavel3").val()==""){
			alert("超过三天主管领导不能为空");
			return false;
		}
