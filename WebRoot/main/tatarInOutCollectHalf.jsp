...
%>
		<tr class="text-c">
				...
				<td nowrap><%=Math.round(Double.valueOf(bean.getWuqian())/2) %>天</td>
				<td nowrap><%=Math.round(Double.valueOf(bean.getChidao())/2) %>天</td>
				<td nowrap><%=Math.round(Double.valueOf(bean.getPianli())/2) %>天</td>	               
		</tr>
	<%}} %>
