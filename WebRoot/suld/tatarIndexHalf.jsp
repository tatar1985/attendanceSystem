...
<body style="background-color: #f9f9f9;">
 <form class="form form-horizontal" action="<%=request.getContextPath()%>/suld_/suld.do" method="post"  id="inOut" name="inOut">
    ...
    <input type="hidden" name="kindCheck" id="kindCheck" value="2"/>
...
<div class="introduce_box">
    ...
    <div class="member" >
        ...
        <h1>晚已退</h1><h2>(17:30-19:00)</h2>
        <%}else{%>
        <img src="<%=request.getContextPath()%>/suld/images/check.jpg">
         <input type="hidden" name="fourId" id="fourId" value="0"/>
        <h1>晚未退</h1><h2>(17:30-19:00)</h2>
        <% } %>
        <div class="border_right"></div>
    </div>   
    <%} %>
    ...
    <div>
    <br>
    <h1 line-height:3px;>注意事项</h1><br>
   <h2 line-height:3px; > 一: 如果一个手机登录两个微信签到，那么两个签到都视为无效签到。</h2><br>
<h2 line-height:3px; >二: 如果一个手机12个小时未移动，则该签到也列为无效签到。</h2>
</div>
    <div class="border_bottom"></div>
