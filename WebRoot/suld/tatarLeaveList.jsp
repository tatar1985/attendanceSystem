    ...
    <%
     ...
     %>
        <div class="order" >
            ...
            <%if(bean.getFLAGSTATE().equals("已通过")){ %>
            <div class="cancel" style="border:#ff7f00 1px solid; color:#ff0000;" onClick="jump(<%=bean.getSid() %>)">销假</div>
            <%} %>
