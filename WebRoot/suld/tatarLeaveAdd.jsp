...
<%@ page import="com.tataren.tatar.domain.TLeaveAdmin"%>
...
<body style="background-color: #f9f9f9;">
 <form class="form form-horizontal" action="<%=request.getContextPath()%>/suld_/suld.do" method="post"  id="tatarForm" name="tatarForm">
    ...
    <input type="hidden" name="headImgUrl" id="headImgUrl" value="<%=webUser.getHeadUrl() %>"/>
...
<div class="column_box">
    ...
    <input placeholder="请假人" id="trueName" name="trueName" value="<%=webUser.getUserName()==null?"":webUser.getUserName() %>"></input>
...
<div class="column_box">
	<div class="column_img"><img src="<%=request.getContextPath()%>/suld/images/adrress_2.png"></div>
     <input placeholder="单位名称" id="unitName" name="unitName" value="<%=webUser.getUnitName()==null?"":webUser.getUnitName() %>"/>
    <div class="border_bottom"></div>
</div>
 -->
<div class="column_box">
	<div class="column_img"><img src="<%=request.getContextPath()%>/suld/images/adrress_2.png"></div>
     <input placeholder="科室名称" id="department" name="department" value="<%=webUser.getDepartmentName() ==null?"":webUser.getDepartmentName() %>"></input>
    <div class="border_bottom"></div>
</div>
...
<div class="column_box">
	...
	<select id="adminLeavel1" name="adminLeavel1" id="adminLeavel1">
		...
		TLeaveAdmin bean = (TLeaveAdmin) iter.next();
		if(bean.getKind().equals("1")){System.out.println(bean.getUserName());
     %>
     <option value="<%=bean.getSid() %>-<%=bean.getUserName() %>"><%=bean.getUserName() %></option>
     <%}}} %>
...
<div class="column_box_tatar2">
    ...
    <input name="startTime" class="ipt datepicker" size="16" type="text" id="starTime"  placeholder="开始时间" style="height: 46px; width: 89px; " readOnly="readOnly"/>
...
<div class="column_box_tatar2">
	<div class="column_img_tatar"><img src="<%=request.getContextPath()%>/suld/images/time.png"></div>
	<input name="endTime" class="ipt datepicker" size="16" type="text" id="endTime"  placeholder="结束时间" style="height: 46px; width: 89px; " readOnly="readOnly"/>
