...
<body style="background-color: #f9f9f9;">
 <form class="form form-horizontal" action="<%=request.getContextPath()%>/suld_/suld.do" method="post"  id="tatarForm" name="tatarForm">
   <input type="hidden" name="method" id="method" value="moibleLeaveDeatailAdmin"/>
...
<div class="move">
    ...
    <%
    	List proTLeaves = (List) request.getSession().getAttribute("listAdminPro");
     ...
     %>
        <div class="order" >
            ...
            <div class="cancel" style="border:#ff7f00 1px solid; color:#ff7f00;" onClick="init(<%=bean.getSid() %>)">审批</div>
            <div class="border_bottom"></div>
             </div> 
        <%}} %>
    ...
    <div class="order_box">
    <%
    	List succTLeaves = (List) request.getSession().getAttribute("listAdminSucc");
