...
public class BeanUtils {
	...
	public static Integer[] boxingArray(int[] values) {
		Integer[] array = new Integer[values.length];
		for (int i = 0; i < array.length; i++) {
			// auto boxing
			array[i] = new Integer(values[i]);
		}
		return array;
	}

	public static Short[] boxingArray(short[] values) {
		Short[] array = new Short[values.length];
		for (int i = 0; i < array.length; i++) {
			// auto boxing
			array[i] = new Short(values[i]);
		}
		return array;
	}

	public static Long[] boxingArray(long[] values) {
		Long[] array = new Long[values.length];
		for (int i = 0; i < array.length; i++) {
			// auto boxing
			array[i] = new Long(values[i]);
		}
		return array;
	}

	public static Byte[] boxingArray(byte[] values) {
		Byte[] array = new Byte[values.length];
		for (int i = 0; i < array.length; i++) {
			// auto boxing
			array[i] = new Byte(values[i]);
		}
		return array;
	}

	public static Double[] boxingArray(double[] values) {
	...
	public static Float[] boxingArray(float[] values) {
		Float[] array = new Float[values.length];
		for (int i = 0; i < array.length; i++) {
			// auto boxing
			array[i] = new Float(values[i]);
		}
		return array;
	}

	public static Boolean[] boxingArray(boolean[] values) {
		Boolean[] array = new Boolean[values.length];
		for (int i = 0; i < array.length; i++) {
			// auto boxing
			array[i] = new Boolean(values[i]);
		}
		return array;
	}

	public static Character[] boxingArray(char[] values) {
		Character[] array = new Character[values.length];
		for (int i = 0; i < array.length; i++) {
			// auto boxing
			array[i] = new Character(values[i]);
		}
		return array;
	}
	 ...
	 *                if a new instance of the bean's class cannot be
	 *                instantiated
	 ...
	 *                if the <code>dest</code> or <code>orig</code> argument
	 *                is null
	 * @exception InvocationTargetException
	 *                if the property accessor method throws an exception
	 * @exception NullPointerException
	 *                if <code>orig</code> or <code>dest</code> is
	 *                <code>null</code>
	 */
	...
	public static void setProperty(Object bean, String name, Object value)
		...
		if (target instanceof DynaBean) {
			...
			if (value != null) {
				// FIXME: AD HOC, convert bigdecimal to int
				if (value.getClass().equals(BigDecimal.class)) {
					if (descriptor.getPropertyType().equals(Float.class)
					...
					if (descriptor.getPropertyType().equals(int.class)
							|| descriptor.getPropertyType().equals(
									Integer.class)) {
					...
					if (descriptor.getPropertyType().equals(Boolean.class)
							|| descriptor.getPropertyType().equals(
									boolean.class)) {
						value = ((BigDecimal) value).intValue() == 1 ? Boolean.TRUE
								: Boolean.FALSE;
					}
				}
				if (value.getClass().equals(Integer.class)) {
					if (descriptor.getPropertyType().equals(Float.class)
							|| descriptor.getPropertyType().equals(float.class)) {
						value = new Float(((Integer) value).floatValue());
					}
					if (descriptor.getPropertyType().equals(Double.class)
							|| descriptor.getPropertyType()
									.equals(double.class)) {
					...
					if (descriptor.getPropertyType().equals(Boolean.class)
							|| descriptor.getPropertyType().equals(
									boolean.class)) {
						value = ((Integer) value).intValue() == 1 ? Boolean.TRUE
								: Boolean.FALSE;
					}
				}

				// FIXME: AD HOC, convert int to boolean
...
//				}
		...
		if (type.isArray() && (index < 0)) { // Scalar value into array
			...
			newValue = value;// by jack 2008-09-12 02:14
			// Value into scalar
